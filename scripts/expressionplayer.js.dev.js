...
ExpressionPlayer.UrlParam = {
	...
	wmSource    :   "wmSource",     // location of the watermark image
	wmOpacity   :   "wmOpacity",    // opacity of the watermark image
	wpPosition  :   "wmPosition",   // position of the watermark image
...
ExpressionPlayer.Player.prototype =  {
	...
	initialize: function() {
		...
		this.set_watermarkSource( $getArgument(ExpressionPlayer.UrlParam.wmSource, this.get_watermarkSource()) );
		this.set_watermarkOpacity( $getArgument(ExpressionPlayer.UrlParam.wmOpacity, this.get_watermarkOpacity()) );
		this.set_watermarkPosition( $getArgument(ExpressionPlayer.UrlParam.wpPosition, this.get_watermarkPosition()) );
